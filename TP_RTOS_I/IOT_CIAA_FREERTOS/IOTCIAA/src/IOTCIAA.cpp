...
// Creamos un objeto del tipo  FSMprotocol que se encargara
// de procesar los mensajes recibidos por la UART
...
// Implementacion de funcion de la tarea pulsador
void tarea_pulsador(void* taskParmPtr) {
...
// Implementacion de funcion de la tarea uart
void tarea_uart(void* taskParmPtr) {
...
/*
 *	se ejecuta recibe un mensaje por la UART
 *	y este fue procesado y aprobado por el protocolo
 */
...
int main(void) {
	...
	xTaskCreate(tarea_uart,                     // Funcion de la tarea a ejecutar
